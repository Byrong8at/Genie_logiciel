...
public class Controller
{
    ...
    static Dictionary<string, (string fr, string en)> messages = new Dictionary<string, (string, string)>()
    {
        ...
        ["menu_7"] = ("Quitter", "Quit"),
        ["target_execute_desc"] = ("Entrez un nom de sauvegarde, ou '*' pour tout éxécuter :","Enter a bakcup name, or '*' to execute all :"),
        ["number"] = ("Numéro", "Number"),
        ["name"] = ("Nom", "Name"),
        ["target"] = ("Cible","Target"),
        ["source"] = ("Source","Source"),
        ["log_type"] = ("Type de log","Type of log"),
        ["execute"] = ("Exécuter","Execute"),
        ["delete"] = ("Supprimer","Delete"),
        ["add"] = ("Ajouter","Add"),
        ["name_backup"] = ("Nom de la sauvegarde :","Name of the backup :"),
        ["select_source_path"] = ("Séléctionner un chemin de source","Select a source path"),
        ["select_target_path"] = ("Séléctionner un chemin de cible", "Select a target path"),
        ["select_log_type"] = ("Format de fichier log (dernier utilisé par défaut) :", "Type of log (last used by default) :"),
        ["create_backup"] = ("Créer la sauvegarde","Create the backup"),
        ["check_pro_job"] = ("Vérification du logiciel métier","Professionnal software check"),
        ["pro_job"] = ("Logiciel métier","Professionnal software"),
        ["current_backup"] = ("Sauvegarde(s) en cours","Current backup(s)"),
        ["progress"] = ("Avancement","Progress"),
        ["size"] = ("Taille", "Size"),
        ["input_empty"] = ("Veuillez renseigner tout les champs.", "Please fill in all fields before creating a backup."),
        ["error"] = ("Erreur","Error"),
        ["software_running"] = ("Présence de logiciel métier détecté, merci de le fermer avant de continuer.", "Professionnal software detected, please close it before continuing."),
        ...
        ["enter_backup_name_error"] = ("Merci d'entrer un nom de sauvegarde.","Please enter a backup name."),
        ["not_found"] = ("Aucune sauvegarde trouvée avec ce nom.", "No backup found with this name."),
